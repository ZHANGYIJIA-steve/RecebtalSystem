...
class EstateViewController: UITableViewController {
...
//        }
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return fetchedResultsController.sections?[section].numberOfObjects ?? 0//        return Apartment.sampleData.count
    }
...
//        cell.textLabel?.text = Apartment.sampleData[indexPath.row].estate;
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let viewController = segue.destination as? propertyTableViewController {
            ...
            viewController.estate = fetchedResultsController.object(at: selectedIndex).estate
...
extension EstateViewController: NSFetchedResultsControllerDelegate {
