...
class MyRentalTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "myrentalscell", for: indexPath)
        cell.textLabel?.text = apartments[indexPath.row].property_title
        cell.detailTextLabel?.text = apartments[indexPath.row].estate
